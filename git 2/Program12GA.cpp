...

{
    ...
    std::cout << "Enter the number of Population in each iteration is : ";

    cin >> n;

    std::cout << "Enter the number of iteration is : ";
    ...
    cout << "\n\nAfter the " << ico1 << " Iteration, the Maximum Value is : " << m_max;
}
